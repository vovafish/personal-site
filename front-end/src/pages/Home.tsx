      ...
      <div className="min-h-screen flex items-center justify-center pt-20 pb-5">
        <div className="max-w-4xl mx-auto px-6 py-4 bg-white rounded-lg shadow-lg">
          ...
          <div className="text-base grid grid-cols-1 md:grid-cols-2 gap-8">
            <p className="transform -translate-y-2 translate-x-4 mb-6 text-gray-800 border-b-2 border-blue-500 pb-4">
            ...
            <p className="transform translate-y-12 -translate-x-4 mb-6 text-gray-800 ml-10 border-b-2 border-blue-500 pb-4">
